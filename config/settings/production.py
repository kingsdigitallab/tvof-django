...
ALLOWED_HOSTS = env.list("VIRTUAL_HOST", default=["tvof.ac.uk"])
...
# Always accept http requests because the conversion is made higher up the stack
...
LDAP_PROJECT_GROUP = f"cn=tvof,{LDAP_BASE_OU}"
