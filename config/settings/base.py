...
KILN_STATIC_PATH = os.path.join(MEDIA_ROOT, 'kiln_out')
...
DATA_RELEASE = {
    ...
    'files': OrderedDict([
        ['fr_semi_diplomatic', {
            ...
            'path': os.path.join(KILN_STATIC_PATH, 'backend-texts-fr20125-semi-diplomatic'),
            'group': 'tei',
        }],
        ['fr_interpretive', {
            'name': 'Fr interpretive',
            'path': os.path.join(KILN_STATIC_PATH, 'backend-texts-fr20125-interpretive'),
            'group': 'tei',
        }],
        ['royal_semi_diplomatic', {
            'name': 'Royal semi-diplomatic',
            'path': os.path.join(KILN_STATIC_PATH, 'backend-texts-royal-semi-diplomatic'),
            'group': 'tei',
        }],
        ['royal_interpretive', {
            'name': 'Royal interpretive',
            'path': os.path.join(KILN_STATIC_PATH, 'backend-texts-royal-interpretive'),
            'group': 'tei',
        }],

        ['bibliography', {
            'name': 'Bibliography',
            'path': os.path.join(KILN_STATIC_PATH, 'backend-bibliography'),
            'group': 'tei',
        }],
        ['alignment', {
            'name': 'Alignment',
            'path': os.path.join(KILN_STATIC_PATH, 'backend-preprocess-alists-tvofparaalignmentxml'),
            'group': 'tei',
        }],

        ['kwic_out', {
            'name': 'Kwic out',
            'path': os.path.join(KILN_STATIC_PATH, 'received/kwic-out.xml'),
            'group': 'search',
        }],
        ['fr_tokenised', {
            'name': 'Fr Tokenised',
            'path': os.path.join(KILN_STATIC_PATH, 'prepared/fr_tokenised.xml'),
            'group': 'search',
        }],
        ['royal_tokenised', {
            'name': 'Royal Tokenised',
            'path': os.path.join(KILN_STATIC_PATH, 'prepared/royal_tokenised.xml'),
            'group': 'search',
        }],
    ]),
